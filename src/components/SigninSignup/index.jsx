...
function SignupSigninComponent() {
  ...
  return (
    <>
      {loginForm ? (
        <div
          className="bg-white w-3/4 max-w-[550px] h-auto rounded-2xl px-6 py-8 leading-normal"
        ...
        >
          ...
          <form>
            ...
            onClick={googleAuth}
              ...
              green={true}
            />
            <p className="text-center font-medium -m-2">
              Or Don't Have an Account Already?{" "}
              <span
                onClick={() => setLoginForm(!loginForm)}
                style={{ color: "var(--card_in)" }}
                className="cursor-pointer underline italic font-bold"
              >
                Click Here
              </span>
            </p>
        ...
        <div
          className="bg-white w-3/4 max-w-[550px] h-auto rounded-2xl px-6 py-5 leading-normal"
          style={{ boxShadow: "var(--shadow)" }}
        >
          <h2 className="text-gray-700 text-[1.2rem] text-center">
            Sign up on{" "}
