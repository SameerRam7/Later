...
function Cards({ income, expense, totalBalance,showExpenseModal, showIncomeModal}) {
  return (
    <div>
      <Row className='flex justify-between items-center flex-wrap w-11/12 my-6 mx-auto'>
        <Card className='m-8 text-white border-none min-w-80 min-h-[320px] p-4 font-Mons flex-1' style={{backgroundColor: "var(--card_bc)"}}>
        ...
        <Card /* title="Total Income" */ className='m-8 text-white border-none min-w-80 min-h-[320px] p-4 font-Mons flex-1' style={{backgroundColor: "var(--card_bc)"}}>
        ...
        <Card /* title="Total Expenses" */ className='m-8 text-white border-none min-w-80 min-h-[320px] p-4 font-Mons flex-1' style={{backgroundColor: "var(--card_bc)"}}>
